<%@ Page Language="C#" AutoEventWireup="true" Inherits="Archive" Codebehind="Archive.aspx.cs" %>

<%@ Register Src="NewsTemplate.ascx" TagName="NewsTemplate" TagPrefix="uc3" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Архива на вести</title>
    <!-- Title icon -->
                    ...
                    <div id="news-wrapper">
                        ...
                        <div id="news-container">
                            <asp:GridView ID="gvNews" runat="server" AutoGenerateColumns="False" Width="100%"
                                ...
                                AllowPaging="True" OnPageIndexChanging="gvNews_PageIndexChanging">
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
