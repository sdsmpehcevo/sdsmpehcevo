<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WomenManagementTeam.aspx.cs"
    Inherits="WomenManagementTeam" %>

<%@ Register Src="MemberTemplate.ascx" TagName="MemberTemplate" TagPrefix="uc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Клуб на жени</title>
    <!-- Title icon -->
        ...
        <div class="separator">
            <div id="content-container">
                ...
                <div id="content-right">
                    ...
                    <div id="coordinator-title" style="margin: 20px 0 5px 5px;">
                        <h2>
                            Координатор</h2>
                    </div>
                    <div class="separator">
                    </div>
                    <div id="coordinatorContent" runat="server">
                    </div>
                </div>
            </div>
            <div class="reklami">
