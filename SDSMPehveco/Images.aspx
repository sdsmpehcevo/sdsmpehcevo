<%@ Page Language="C#" AutoEventWireup="true" Inherits="Images" Codebehind="Images.aspx.cs" %>

<%@ Register Src="~/AlbumTemplate.ascx" TagName="AlbumTemplate" TagPrefix="uc6" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Галерија на слики</title>
    <!-- Title icon -->
        ...
        <div class="separator">
            <div id="content-container">
                ...
                <div id="content-right">
                    <div id="title">
                        <h2>
                            Галерија на слики</h2>
                        <br />
                        <br />
                    </div>
                    <div style="margin: 20px 0 5px 5px;">
                    </div>
                    <div id="albumsContent">
                        <asp:GridView ID="gvAlbums" runat="server" AutoGenerateColumns="False" Width="100%"
                            BorderStyle="None" GridLines="None" ShowHeader="False" AllowPaging="True" PageSize="5"
                            OnPageIndexChanging="gvAlbums_PageIndexChanging" OnRowDataBound="gvAlbums_RowDataBound">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <uc6:AlbumTemplate ID="albumTmp" runat="server" />
                                    </ItemTemplate>
