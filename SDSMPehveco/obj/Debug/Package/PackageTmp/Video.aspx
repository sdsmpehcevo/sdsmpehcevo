        ...
        <div class="separator">
            <div id="content-container">
                ...
                <div id="content-right">
                    ...
                    <div id="videoHolder" runat="server">
                        <asp:GridView ID="gvVideos" runat="server" AutoGenerateColumns="False" Width="100%"
                            BorderStyle="None" GridLines="None" ShowHeader="False" OnRowDataBound="gvVideos_RowDataBound"
                            AllowPaging="True" OnPageIndexChanging="gvVideos_PageIndexChanging" PageSize="5">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <uc2:VideoTemplate ID="vidTmp" runat="server" />
                                    </ItemTemplate>
