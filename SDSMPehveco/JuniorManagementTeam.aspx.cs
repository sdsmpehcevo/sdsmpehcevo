...
public partial class JuniorManagementTeam : System.Web.UI.Page
{
    ...
    protected void getPresident()
    {
        ...
        SqlCommand cmd = db.GetCommand(conn, "dbo.GetPresidentM");
    ...
    protected void getSecretary()
    {
        DataBase db = new DataBase();
        SqlConnection conn = db.Connection();
        SqlCommand cmd = db.GetCommand(conn, "dbo.GetSecretaryM");
    ...
    protected void getIOMembers()
    {
        DataBase db = new DataBase();
        SqlConnection conn = db.Connection();
        SqlCommand cmd = db.GetCommand(conn, "dbo.GetIOMembersM");
    ...
    protected void getNOMembers()
    {
        DataBase db = new DataBase();
        SqlConnection conn = db.Connection();
        SqlCommand cmd = db.GetCommand(conn, "dbo.GetNOMembersM");
